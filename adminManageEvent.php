...
<!Doctype HTML>
  ...
  <title>RaktaSewa</title>
	...
	<body>
	  ...
	  <a href="adminManageEvent.php"class="active icon-a"><i class="fa fa-calendar-days icons"></i>  Manage Event</a>
	...
	<div id="main">
		...
		<div class="head">
			<div class="col-div-6">
	<span style="font-size:30px;cursor:pointer; color: black;" class="nav"  >☰ Manage Event</span>
	<span style="font-size:30px;cursor:pointer; color: black;" class="nav2"  >☰ Manage Event</span>
	</div>
...
<td colspan="2"><?php echo $row['organizer']?></td>



<td><button class="btn"><a href="delete1.php?deleteid='<?php echo $row['id']?>'">Delete</a></button></td>
